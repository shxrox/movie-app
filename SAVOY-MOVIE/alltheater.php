...
<head>
    ...
    <link rel="stylesheet" href="alltheater.css">
                              ...
                              <div class="col-lg-3 col-md-6 d-flex align-items-stretch aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">
                                <div class="member">
                                  <div class="member-img">
                                    ...
                                    <div class="social">
                                      <a href="admin/uploads/<?= $data['trailer'] ?>" target="_blank" id="watchnow" class="btn btn-primary" style="width:150px;">Watch Trailer</a>
                                  ...
                                  <div class="member-info">
                                    ...
                                    <a href="booking.php?id=<?=$data['theaterid']?>" id="bnt-book" target="_blank" class="btn btn-primary"> Book Now </a>
